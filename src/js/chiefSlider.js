...
ChiefSlider.prototype._addIndicators = function () {
  ...
  ol.classList.add(`indicators-list`);
  ol.classList.add(`slider__indicators`);

  const createLi = (number) => {
    const li = document.createElement(`li`);
    li.classList.add(`indicators-item`);
    li.dataset.slideTo = number

    return li
  };

  for (let i = 0; i < this._$itemList.length; i++) {
    ol.appendChild(createLi(i))
  }

  this._$wrapper.insertAdjacentElement(`afterend`, ol)
}
